...
url_list = [
        ...
        # 'http://136.244.114.199/clash/proxies',  # 20220512经常超时
        # 'https://klausvpn.posyao.com/clash/proxies?type=vmess',  # 20220512经常超时
        # 'https://klausvpn.posyao.com/clash/proxies',  # 20220512经常超时
        # 'http://www.fuckgfw.tk/clash/proxies',  # 20220512经常超时
    ]
db = RedisClient()
